...
var r = { background: "{overlay.select.background}", borderColor: "{overlay.select.border.color}", borderRadius: "{overlay.select.border.radius}", color: "{overlay.select.color}", shadow: "{overlay.select.shadow}" };
var d = { padding: "{list.padding}", gap: "{list.gap}" };
var e = { focusBackground: "{list.option.focus.background}", selectedBackground: "{list.option.selected.background}", selectedFocusBackground: "{list.option.selected.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", selectedColor: "{list.option.selected.color}", selectedFocusColor: "{list.option.selected.focus.color}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}" };
...
var a = { root: o, overlay: r, list: d, option: e, optionGroup: l, dropdown: i, chip: c2, emptyMessage: f, colorScheme: s };

// node_modules/@primeuix/themes/dist/aura/avatar/index.mjs
var e2 = { width: "2rem", height: "2rem", fontSize: "1rem", background: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}" };
var r2 = { size: "1rem" };
var o2 = { borderColor: "{content.background}", offset: "-0.75rem" };
var t = { width: "3rem", height: "3rem", fontSize: "1.5rem", icon: { size: "1.5rem" }, group: { offset: "-1rem" } };
var i2 = { width: "4rem", height: "4rem", fontSize: "2rem", icon: { size: "2rem" }, group: { offset: "-1.5rem" } };
var n = { root: e2, icon: r2, group: o2, lg: t, xl: i2 };

// node_modules/@primeuix/themes/dist/aura/badge/index.mjs
var r3 = { borderRadius: "{border.radius.md}", padding: "0 0.5rem", fontSize: "0.75rem", fontWeight: "700", minWidth: "1.5rem", height: "1.5rem" };
var o3 = { size: "0.5rem" };
var e3 = { fontSize: "0.625rem", minWidth: "1.25rem", height: "1.25rem" };
...
var r8 = { padding: "1.25rem", gap: "0.5rem" };
var t3 = { gap: "0.5rem" };
var e6 = { fontSize: "1.25rem", fontWeight: "500" };
var a3 = { color: "{text.muted.color}" };
var d3 = { root: o8, body: r8, caption: t3, title: e6, subtitle: a3 };
...
var t4 = { root: r9, content: o9, indicatorList: a4, indicator: i4, colorScheme: c4 };
...
var r10 = { width: "2.5rem", color: "{form.field.icon.color}" };
...
var e7 = { focusBackground: "{list.option.focus.background}", selectedBackground: "{list.option.selected.background}", selectedFocusBackground: "{list.option.selected.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", selectedColor: "{list.option.selected.color}", selectedFocusColor: "{list.option.selected.focus.color}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}", icon: { color: "{list.option.icon.color}", focusColor: "{list.option.icon.focus.color}", size: "0.875rem" } };
var i5 = { color: "{form.field.icon.color}" };
var f2 = { root: o10, dropdown: r10, overlay: d4, list: l2, option: e7, clearIcon: i5 };

// node_modules/@primeuix/themes/dist/aura/checkbox/index.mjs
var r11 = { borderRadius: "{border.radius.sm}", width: "1.25rem", height: "1.25rem", background: "{form.field.background}", checkedBackground: "{primary.color}", checkedHoverBackground: "{primary.hover.color}", disabledBackground: "{form.field.disabled.background}", filledBackground: "{form.field.filled.background}", borderColor: "{form.field.border.color}", hoverBorderColor: "{form.field.hover.border.color}", focusBorderColor: "{form.field.border.color}", checkedBorderColor: "{primary.color}", checkedHoverBorderColor: "{primary.hover.color}", checkedFocusBorderColor: "{primary.color}", checkedDisabledBorderColor: "{form.field.border.color}", invalidBorderColor: "{form.field.invalid.border.color}", shadow: "{form.field.shadow}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" }, transitionDuration: "{form.field.transition.duration}", sm: { width: "1rem", height: "1rem" }, lg: { width: "1.5rem", height: "1.5rem" } };
var o11 = { size: "0.875rem", color: "{form.field.color}", checkedColor: "{primary.contrast.color}", checkedHoverColor: "{primary.contrast.color}", disabledColor: "{form.field.disabled.color}", sm: { size: "0.75rem" }, lg: { size: "1rem" } };
var e8 = { root: r11, icon: o11 };

// node_modules/@primeuix/themes/dist/aura/chip/index.mjs
var o12 = { borderRadius: "16px", paddingX: "0.75rem", paddingY: "0.5rem", gap: "0.5rem", transitionDuration: "{transition.duration}" };
var r12 = { width: "2rem", height: "2rem" };
var e9 = { size: "1rem" };
...
var s2 = { root: o12, image: r12, icon: e9, removeIcon: c5, colorScheme: i6 };

// node_modules/@primeuix/themes/dist/aura/colorpicker/index.mjs
var r13 = { transitionDuration: "{transition.duration}" };
var o13 = { width: "1.5rem", height: "1.5rem", borderRadius: "{form.field.border.radius}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
...
var s3 = { root: r13, preview: o13, panel: e10, colorScheme: a5 };

// node_modules/@primeuix/themes/dist/aura/confirmdialog/index.mjs
var o14 = { size: "2rem", color: "{overlay.modal.color}" };
var e11 = { gap: "1rem" };
var r14 = { icon: o14, content: e11 };

// node_modules/@primeuix/themes/dist/aura/confirmpopup/index.mjs
var o15 = { background: "{overlay.popover.background}", borderColor: "{overlay.popover.border.color}", color: "{overlay.popover.color}", borderRadius: "{overlay.popover.border.radius}", shadow: "{overlay.popover.shadow}", gutter: "10px", arrowOffset: "1.25rem" };
var r15 = { padding: "{overlay.popover.padding}", gap: "1rem" };
...
var a6 = { root: o15, content: r15, icon: e12, footer: p };

// node_modules/@primeuix/themes/dist/aura/contextmenu/index.mjs
var o16 = { background: "{content.background}", borderColor: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}", shadow: "{overlay.navigation.shadow}", transitionDuration: "{transition.duration}" };
...
var t5 = { size: "{navigation.submenu.icon.size}", color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}", activeColor: "{navigation.submenu.icon.active.color}" };
var r16 = { borderColor: "{content.border.color}" };
var c6 = { root: o16, list: i7, item: n3, submenu: a7, submenuIcon: t5, separator: r16 };

// node_modules/@primeuix/themes/dist/aura/datatable/index.mjs
var o17 = { transitionDuration: "{transition.duration}" };
var r17 = { background: "{content.background}", borderColor: "{datatable.border.color}", color: "{content.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem", sm: { padding: "0.375rem 0.5rem" }, lg: { padding: "1rem 1.25rem" } };
...
var k = { root: o17, header: r17, headerCell: e13, columnTitle: d5, row: t6, bodyCell: l3, footerCell: c7, columnFooter: n4, footer: a8, dropPoint: i8, columnResizer: s4, resizeIndicator: g, sortIcon: u, loadingIcon: b, rowToggleButton: p2, filter: m, paginatorTop: h, paginatorBottom: f3, colorScheme: v };

// node_modules/@primeuix/themes/dist/aura/dataview/index.mjs
var o18 = { borderColor: "transparent", borderWidth: "0", borderRadius: "0", padding: "0" };
var r18 = { background: "{content.background}", color: "{content.color}", borderColor: "{content.border.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem", borderRadius: "0" };
...
var t7 = { borderColor: "{content.border.color}", borderWidth: "0 0 1px 0" };
var n5 = { borderColor: "{content.border.color}", borderWidth: "1px 0 0 0" };
var c8 = { root: o18, header: r18, content: d6, footer: e14, paginatorTop: t7, paginatorBottom: n5 };

// node_modules/@primeuix/themes/dist/aura/datepicker/index.mjs
var o19 = { transitionDuration: "{transition.duration}" };
var r19 = { background: "{content.background}", borderColor: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}", shadow: "{overlay.popover.shadow}", padding: "{overlay.popover.padding}" };
...
var t8 = { hoverBackground: "{content.hover.background}", color: "{content.color}", hoverColor: "{content.hover.color}", padding: "0.25rem 0.5rem", borderRadius: "{content.border.radius}" };
...
var k2 = { root: o19, panel: r19, header: e15, title: c9, dropdown: d7, inputIcon: n6, selectMonth: t8, selectYear: a9, group: i9, dayView: l4, weekDay: u2, date: s5, monthView: g2, month: f4, yearView: h2, year: b2, buttonbar: m2, timePicker: p3, colorScheme: v2 };

// node_modules/@primeuix/themes/dist/aura/dialog/index.mjs
var o20 = { background: "{overlay.modal.background}", borderColor: "{overlay.modal.border.color}", color: "{overlay.modal.color}", borderRadius: "{overlay.modal.border.radius}", shadow: "{overlay.modal.shadow}" };
var a10 = { padding: "{overlay.modal.padding}", gap: "0.5rem" };
var d8 = { fontSize: "1.25rem", fontWeight: "600" };
var r20 = { padding: "0 {overlay.modal.padding} {overlay.modal.padding} {overlay.modal.padding}" };
var l5 = { padding: "0 {overlay.modal.padding} {overlay.modal.padding} {overlay.modal.padding}", gap: "0.5rem" };
var e16 = { root: o20, header: a10, title: d8, content: r20, footer: l5 };

// node_modules/@primeuix/themes/dist/aura/divider/index.mjs
var r21 = { borderColor: "{content.border.color}" };
var o21 = { background: "{content.background}", color: "{text.color}" };
...
var t9 = { root: r21, content: o21, horizontal: n7, vertical: e17 };

// node_modules/@primeuix/themes/dist/aura/dock/index.mjs
var r22 = { background: "rgba(255, 255, 255, 0.1)", borderColor: "rgba(255, 255, 255, 0.2)", padding: "0.5rem", borderRadius: "{border.radius.xl}" };
var o22 = { borderRadius: "{content.border.radius}", padding: "0.5rem", size: "3rem", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var d9 = { root: r22, item: o22 };

// node_modules/@primeuix/themes/dist/aura/drawer/index.mjs
var o23 = { background: "{overlay.modal.background}", borderColor: "{overlay.modal.border.color}", color: "{overlay.modal.color}", shadow: "{overlay.modal.shadow}" };
var a11 = { padding: "{overlay.modal.padding}" };
var d10 = { fontSize: "1.5rem", fontWeight: "600" };
var r23 = { padding: "0 {overlay.modal.padding} {overlay.modal.padding} {overlay.modal.padding}" };
var l6 = { padding: "{overlay.modal.padding}" };
var e18 = { root: o23, header: a11, title: d10, content: r23, footer: l6 };

// node_modules/@primeuix/themes/dist/aura/editor/index.mjs
var o24 = { background: "{content.background}", borderColor: "{content.border.color}", borderRadius: "{content.border.radius}" };
var r24 = { color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{primary.color}" };
...
var t10 = { focusBackground: "{list.option.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}" };
...
var l7 = { toolbar: o24, toolbarItem: r24, overlay: e19, overlayOption: t10, content: d11 };

// node_modules/@primeuix/themes/dist/aura/fieldset/index.mjs
var o25 = { background: "{content.background}", borderColor: "{content.border.color}", borderRadius: "{content.border.radius}", color: "{content.color}", padding: "0 1.125rem 1.125rem 1.125rem", transitionDuration: "{transition.duration}" };
var r25 = { background: "{content.background}", hoverBackground: "{content.hover.background}", color: "{content.color}", hoverColor: "{content.hover.color}", borderRadius: "{content.border.radius}", borderWidth: "1px", borderColor: "transparent", padding: "0.5rem 0.75rem", gap: "0.5rem", fontWeight: "600", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var t11 = { color: "{text.muted.color}", hoverColor: "{text.hover.muted.color}" };
var n8 = { padding: "0" };
var e20 = { root: o25, legend: r25, toggleIcon: t11, content: n8 };

// node_modules/@primeuix/themes/dist/aura/fileupload/index.mjs
var r26 = { background: "{content.background}", borderColor: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}", transitionDuration: "{transition.duration}" };
var o26 = { background: "transparent", color: "{text.color}", padding: "1.125rem", borderColor: "unset", borderWidth: "0", borderRadius: "0", gap: "0.5rem" };
var e21 = { highlightBorderColor: "{primary.color}", padding: "0 1.125rem 1.125rem 1.125rem", gap: "1rem" };
var t12 = { padding: "1rem", gap: "1rem", borderColor: "{content.border.color}", info: { gap: "0.5rem" } };
var a12 = { gap: "0.5rem" };
var n9 = { height: "0.25rem" };
var d12 = { gap: "0.5rem" };
var i10 = { root: r26, header: o26, content: e21, file: t12, fileList: a12, progressbar: n9, basic: d12 };

// node_modules/@primeuix/themes/dist/aura/floatlabel/index.mjs
var o27 = { color: "{form.field.float.label.color}", focusColor: "{form.field.float.label.focus.color}", activeColor: "{form.field.float.label.active.color}", invalidColor: "{form.field.float.label.invalid.color}", transitionDuration: "0.2s", positionX: "{form.field.padding.x}", positionY: "{form.field.padding.y}", fontWeight: "500", active: { fontSize: "0.75rem", fontWeight: "400" } };
var i11 = { active: { top: "-1.25rem" } };
var r27 = { input: { paddingTop: "1.5rem", paddingBottom: "{form.field.padding.y}" }, active: { top: "{form.field.padding.y}" } };
var a13 = { borderRadius: "{border.radius.xs}", active: { background: "{form.field.background}", padding: "0 0.125rem" } };
var d13 = { root: o27, over: i11, in: r27, on: a13 };

// node_modules/@primeuix/themes/dist/aura/galleria/index.mjs
var o28 = { borderWidth: "1px", borderColor: "{content.border.color}", borderRadius: "{content.border.radius}", transitionDuration: "{transition.duration}" };
var r28 = { background: "rgba(255, 255, 255, 0.1)", hoverBackground: "rgba(255, 255, 255, 0.2)", color: "{surface.100}", hoverColor: "{surface.0}", size: "3rem", gutter: "0.5rem", prev: { borderRadius: "50%" }, next: { borderRadius: "50%" }, focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var e22 = { size: "1.5rem" };
var t13 = { background: "{content.background}", padding: "1rem 0.25rem" };
...
var l8 = { root: o28, navButton: r28, navIcon: e22, thumbnailsContent: t13, thumbnailNavButton: c10, thumbnailNavButtonIcon: n10, caption: a14, indicatorList: s6, indicatorButton: u3, insetIndicatorList: i12, insetIndicatorButton: d14, closeButton: g3, closeButtonIcon: f5, colorScheme: h3 };

// node_modules/@primeuix/themes/dist/aura/iconfield/index.mjs
var o29 = { color: "{form.field.icon.color}" };
var r29 = { icon: o29 };

// node_modules/@primeuix/themes/dist/aura/iftalabel/index.mjs
var o30 = { color: "{form.field.float.label.color}", focusColor: "{form.field.float.label.focus.color}", invalidColor: "{form.field.float.label.invalid.color}", transitionDuration: "0.2s", positionX: "{form.field.padding.x}", top: "{form.field.padding.y}", fontSize: "0.75rem", fontWeight: "400" };
var l9 = { paddingTop: "1.5rem", paddingBottom: "{form.field.padding.y}" };
var i13 = { root: o30, input: l9 };

// node_modules/@primeuix/themes/dist/aura/image/index.mjs
var o31 = { transitionDuration: "{transition.duration}" };
...
var a16 = { root: r32, text: o33, icon: e24, colorScheme: n11 };
...
var f6 = { root: o35, chip: r34, colorScheme: d15 };

// node_modules/@primeuix/themes/dist/aura/inputgroup/index.mjs
var r35 = { background: "{form.field.background}", borderColor: "{form.field.border.color}", color: "{form.field.icon.color}", borderRadius: "{form.field.border.radius}", padding: "0.5rem", minWidth: "2.5rem" };
var o36 = { addon: r35 };
...
var e25 = { light: { button: { background: "transparent", hoverBackground: "{surface.100}", activeBackground: "{surface.200}", borderColor: "{form.field.border.color}", hoverBorderColor: "{form.field.border.color}", activeBorderColor: "{form.field.border.color}", color: "{surface.400}", hoverColor: "{surface.500}", activeColor: "{surface.600}" } }, dark: { button: { background: "transparent", hoverBackground: "{surface.800}", activeBackground: "{surface.700}", borderColor: "{form.field.border.color}", hoverBorderColor: "{form.field.border.color}", activeBorderColor: "{form.field.border.color}", color: "{surface.400}", hoverColor: "{surface.300}", activeColor: "{surface.200}" } } };
var a17 = { root: r36, button: o37, colorScheme: e25 };

// node_modules/@primeuix/themes/dist/aura/inputotp/index.mjs
var r37 = { gap: "0.5rem" };
var t14 = { width: "2.5rem", sm: { width: "2rem" }, lg: { width: "3rem" } };
var e26 = { root: r37, input: t14 };
...
var r38 = { background: "{primary.color}" };
var t15 = { background: "{content.border.color}" };
var n13 = { color: "{text.muted.color}" };
var c11 = { root: o39, value: r38, range: t15, text: n13 };
...
var r39 = { padding: "{list.padding}", gap: "{list.gap}", header: { padding: "{list.header.padding}" } };
...
var t16 = { color: "{list.option.color}", gutterStart: "-0.375rem", gutterEnd: "0.375rem" };
var e27 = { padding: "{list.option.padding}" };
var l10 = { light: { option: { stripedBackground: "{surface.50}" } }, dark: { option: { stripedBackground: "{surface.900}" } } };
var n14 = { root: o40, list: r39, option: d17, optionGroup: i15, checkmark: t16, emptyMessage: e27, colorScheme: l10 };
...
var r40 = { padding: "{navigation.list.padding}", gap: "{navigation.list.gap}" };
var t17 = { padding: "{navigation.submenu.label.padding}", fontWeight: "{navigation.submenu.label.font.weight}", background: "{navigation.submenu.label.background.}", color: "{navigation.submenu.label.color}" };
var e28 = { size: "{navigation.submenu.icon.size}", color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}", activeColor: "{navigation.submenu.icon.active.color}" };
...
var g4 = { root: o41, baseItem: n15, item: i16, overlay: a18, submenu: r40, submenuLabel: t17, submenuIcon: e28, separator: c12, mobileButton: d18 };
...
var t18 = { borderColor: "{content.border.color}" };
var r41 = { root: o42, list: n16, item: a19, submenuLabel: i17, separator: t18 };
...
var r42 = { padding: "{navigation.list.padding}", gap: "{navigation.list.gap}", background: "{content.background}", borderColor: "{content.border.color}", borderRadius: "{content.border.radius}", shadow: "{overlay.navigation.shadow}", mobileIndent: "1rem", icon: { size: "{navigation.submenu.icon.size}", color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}", activeColor: "{navigation.submenu.icon.active.color}" } };
var a20 = { borderColor: "{content.border.color}" };
var t19 = { borderRadius: "50%", size: "1.75rem", color: "{text.muted.color}", hoverColor: "{text.hover.muted.color}", hoverBackground: "{content.hover.background}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var e29 = { root: o43, baseItem: i18, item: n17, submenu: r42, separator: a20, mobileButton: t19 };
...
var r43 = { padding: "0.5rem 0.75rem", gap: "0.5rem", sm: { padding: "0.375rem 0.625rem" }, lg: { padding: "0.625rem 0.875rem" } };
var e30 = { fontSize: "1rem", fontWeight: "500", sm: { fontSize: "0.875rem" }, lg: { fontSize: "1.125rem" } };
...
var u4 = { root: o44, content: r43, text: e30, icon: n18, closeButton: l11, closeIcon: s7, outlined: c13, simple: a21, colorScheme: d19 };

// node_modules/@primeuix/themes/dist/aura/metergroup/index.mjs
var e31 = { borderRadius: "{content.border.radius}", gap: "1rem" };
var r44 = { background: "{content.border.color}", size: "0.5rem" };
var a22 = { gap: "0.5rem" };
var o45 = { size: "0.5rem" };
var l12 = { size: "1rem" };
var t20 = { verticalGap: "0.5rem", horizontalGap: "1rem" };
var b3 = { root: e31, meters: r44, label: a22, labelMarker: o45, labelIcon: l12, labelList: t20 };
...
var r45 = { background: "{overlay.select.background}", borderColor: "{overlay.select.border.color}", borderRadius: "{overlay.select.border.radius}", color: "{overlay.select.color}", shadow: "{overlay.select.shadow}" };
...
var e32 = { background: "{list.option.group.background}", color: "{list.option.group.color}", fontWeight: "{list.option.group.font.weight}", padding: "{list.option.group.padding}" };
var f7 = { color: "{form.field.icon.color}" };
var a23 = { borderRadius: "{border.radius.sm}" };
var c14 = { padding: "{list.option.padding}" };
var n19 = { root: o46, dropdown: d20, overlay: r45, list: l13, option: i19, optionGroup: e32, chip: a23, clearIcon: f7, emptyMessage: c14 };

// node_modules/@primeuix/themes/dist/aura/orderlist/index.mjs
var r46 = { gap: "1.125rem" };
var a24 = { gap: "0.5rem" };
var o47 = { root: r46, controls: a24 };
...
var r48 = { background: "transparent", hoverBackground: "{content.hover.background}", selectedBackground: "{highlight.background}", color: "{text.muted.color}", hoverColor: "{text.hover.muted.color}", selectedColor: "{highlight.color}", width: "2.5rem", height: "2.5rem", borderRadius: "50%", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var t23 = { color: "{text.muted.color}" };
var e34 = { maxWidth: "2.5rem" };
var n21 = { root: o50, navButton: r48, currentPageReport: t23, jumpToPageInput: e34 };

// node_modules/@primeuix/themes/dist/aura/panel/index.mjs
var r49 = { background: "{content.background}", borderColor: "{content.border.color}", color: "{content.color}", borderRadius: "{content.border.radius}" };
...
var e35 = { padding: "0.375rem 1.125rem" };
var d21 = { fontWeight: "600" };
var t24 = { padding: "0 1.125rem 1.125rem 1.125rem" };
var n22 = { padding: "0 1.125rem 1.125rem 1.125rem" };
var a25 = { root: r49, header: o51, toggleableHeader: e35, title: d21, content: t24, footer: n22 };

// node_modules/@primeuix/themes/dist/aura/panelmenu/index.mjs
var o52 = { gap: "0.5rem", transitionDuration: "{transition.duration}" };
var r50 = { background: "{content.background}", borderColor: "{content.border.color}", borderWidth: "1px", color: "{content.color}", padding: "0.25rem 0.25rem", borderRadius: "{content.border.radius}", first: { borderWidth: "1px", topBorderRadius: "{content.border.radius}" }, last: { borderWidth: "1px", bottomBorderRadius: "{content.border.radius}" } };
...
var i20 = { indent: "1rem" };
var t25 = { color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}" };
var a26 = { root: o52, panel: r50, item: n23, submenu: i20, submenuIcon: t25 };

// node_modules/@primeuix/themes/dist/aura/password/index.mjs
var r51 = { background: "{content.border.color}", borderRadius: "{content.border.radius}", height: ".75rem" };
var o53 = { color: "{form.field.icon.color}" };
var e36 = { background: "{overlay.popover.background}", borderColor: "{overlay.popover.border.color}", borderRadius: "{overlay.popover.border.radius}", color: "{overlay.popover.color}", padding: "{overlay.popover.padding}", shadow: "{overlay.popover.shadow}" };
var a27 = { gap: "0.5rem" };
...
var n24 = { meter: r51, icon: o53, overlay: e36, content: a27, colorScheme: d22 };

// node_modules/@primeuix/themes/dist/aura/picklist/index.mjs
var r52 = { gap: "1.125rem" };
var a28 = { gap: "0.5rem" };
var o54 = { root: r52, controls: a28 };
...
var r53 = { padding: "{overlay.popover.padding}" };
var e37 = { root: o55, content: r53 };

// node_modules/@primeuix/themes/dist/aura/progressbar/index.mjs
var r54 = { background: "{content.border.color}", borderRadius: "{content.border.radius}", height: "1.25rem" };
var o56 = { background: "{primary.color}" };
var e38 = { color: "{primary.contrast.color}", fontSize: "0.75rem", fontWeight: "600" };
var t26 = { root: r54, value: o56, label: e38 };
...
var r56 = { size: "0.75rem", checkedColor: "{primary.contrast.color}", checkedHoverColor: "{primary.contrast.color}", disabledColor: "{form.field.disabled.color}", sm: { size: "0.5rem" }, lg: { size: "1rem" } };
var e39 = { root: o58, icon: r56 };
...
var r57 = { size: "1rem", color: "{text.muted.color}", hoverColor: "{primary.color}", activeColor: "{primary.color}" };
var i21 = { root: o59, icon: r57 };

// node_modules/@primeuix/themes/dist/aura/ripple/index.mjs
var r58 = { light: { root: { background: "rgba(0,0,0,0.1)" } }, dark: { root: { background: "rgba(255,255,255,0.3)" } } };
var o60 = { colorScheme: r58 };

// node_modules/@primeuix/themes/dist/aura/scrollpanel/index.mjs
var r59 = { transitionDuration: "{transition.duration}" };
...
var a29 = { root: r59, bar: o61, colorScheme: s8 };
...
var r60 = { width: "2.5rem", color: "{form.field.icon.color}" };
...
var e40 = { background: "{list.option.group.background}", color: "{list.option.group.color}", fontWeight: "{list.option.group.font.weight}", padding: "{list.option.group.padding}" };
...
var n25 = { root: o62, dropdown: r60, overlay: d23, list: l14, option: i22, optionGroup: e40, clearIcon: f8, checkmark: c15, emptyMessage: a30 };

// node_modules/@primeuix/themes/dist/aura/selectbutton/index.mjs
var r61 = { borderRadius: "{form.field.border.radius}" };
...
var d24 = { root: r61, colorScheme: o63 };

// node_modules/@primeuix/themes/dist/aura/skeleton/index.mjs
var r62 = { borderRadius: "{content.border.radius}" };
...
var o64 = { root: r62, colorScheme: a31 };

// node_modules/@primeuix/themes/dist/aura/slider/index.mjs
var o65 = { transitionDuration: "{transition.duration}" };
var r63 = { background: "{content.border.color}", borderRadius: "{content.border.radius}", size: "3px" };
var n26 = { background: "{primary.color}" };
var t27 = { width: "20px", height: "20px", borderRadius: "50%", background: "{content.border.color}", hoverBackground: "{content.border.color}", content: { borderRadius: "50%", hoverBackground: "{content.background}", width: "16px", height: "16px", shadow: "0px 0.5px 0px 0px rgba(0, 0, 0, 0.08), 0px 1px 1px 0px rgba(0, 0, 0, 0.14)" }, focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var e41 = { light: { handle: { content: { background: "{surface.0}" } } }, dark: { handle: { content: { background: "{surface.950}" } } } };
var a32 = { root: o65, track: r63, range: n26, handle: t27, colorScheme: e41 };
...
var r64 = { borderRadius: "{form.field.border.radius}", roundedBorderRadius: "2rem", raisedShadow: "0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12)" };
var d25 = { root: r64 };
...
var r65 = { background: "{content.border.color}" };
...
var t29 = { root: o66, gutter: r65, handle: n27 };

// node_modules/@primeuix/themes/dist/aura/stepper/index.mjs
var o67 = { transitionDuration: "{transition.duration}" };
var r66 = { background: "{content.border.color}", activeBackground: "{primary.color}", margin: "0 0 0 1.625rem", size: "2px" };
...
var i23 = { root: o67, separator: r66, step: e42, stepHeader: t30, stepTitle: n28, stepNumber: a34, steppanels: c16, steppanel: d26 };

// node_modules/@primeuix/themes/dist/aura/steps/index.mjs
var o68 = { transitionDuration: "{transition.duration}" };
var r67 = { background: "{content.border.color}" };
...
var c17 = { root: o68, separator: r67, itemLink: t31, itemLabel: e43, itemNumber: n29 };

// node_modules/@primeuix/themes/dist/aura/tabmenu/index.mjs
var o69 = { transitionDuration: "{transition.duration}" };
var r68 = { borderWidth: "0 0 1px 0", background: "{content.background}", borderColor: "{content.border.color}" };
...
var n30 = { root: o69, tablist: r68, item: t32, itemIcon: e44, activeBar: c18 };
...
var e45 = { height: "1px", bottom: "-1px", background: "{primary.color}" };
...
var i24 = { root: o70, tablist: r69, tab: t33, tabpanel: n31, navButton: c19, activeBar: e45, colorScheme: a35 };

// node_modules/@primeuix/themes/dist/aura/tabview/index.mjs
var o71 = { transitionDuration: "{transition.duration}" };
var r70 = { background: "{content.background}", borderColor: "{content.border.color}" };
...
var e46 = { root: o71, tabList: r70, tab: t34, tabPanel: n32, navButton: a36, colorScheme: c20 };

// node_modules/@primeuix/themes/dist/aura/tag/index.mjs
var r71 = { fontSize: "0.875rem", fontWeight: "700", padding: "0.25rem 0.5rem", gap: "0.25rem", borderRadius: "{content.border.radius}", roundedBorderRadius: "{border.radius.xl}" };
...
var n33 = { root: r71, icon: o72, colorScheme: a37 };

// node_modules/@primeuix/themes/dist/aura/terminal/index.mjs
var r72 = { background: "{form.field.background}", borderColor: "{form.field.border.color}", color: "{form.field.color}", height: "18rem", padding: "{form.field.padding.y} {form.field.padding.x}", borderRadius: "{form.field.border.radius}" };
var o73 = { gap: "0.25rem" };
var d27 = { margin: "2px 0" };
var e47 = { root: r72, prompt: o73, commandResponse: d27 };
...
var r73 = { borderColor: "{content.border.color}" };
var c21 = { root: o75, list: i25, item: n34, submenu: a38, submenuIcon: t35, separator: r73 };

// node_modules/@primeuix/themes/dist/aura/timeline/index.mjs
var e48 = { minHeight: "5rem" };
var r74 = { eventContent: { padding: "1rem 0" } };
...
var d29 = { event: e48, horizontal: r74, vertical: o76, eventMarker: n35, eventConnector: t36 };
...
var e50 = { padding: "0.25rem 0.75rem", borderRadius: "{content.border.radius}", checkedShadow: "0px 1px 2px 0px rgba(0, 0, 0, 0.02), 0px 1px 2px 0px rgba(0, 0, 0, 0.04)", sm: { padding: "0.25rem 0.75rem" }, lg: { padding: "0.25rem 0.75rem" } };
...
var c24 = { root: r77, handle: o79, colorScheme: e51 };
...
var r79 = { maxWidth: "12.5rem", gutter: "0.25rem", shadow: "{overlay.popover.shadow}", padding: "0.5rem 0.75rem", borderRadius: "{overlay.popover.border.radius}" };
var o81 = { light: { root: { background: "{surface.700}", color: "{surface.0}" } }, dark: { root: { background: "{surface.700}", color: "{surface.0}" } } };
var e52 = { root: r79, colorScheme: o81 };
...
var d31 = { root: o82, node: r80, nodeIcon: e53, nodeToggleButton: t38, loadingIcon: c25, filter: n37 };
...
var r81 = { width: "2.5rem", color: "{form.field.icon.color}" };
...
var e54 = { padding: "{list.option.padding}" };
var i26 = { borderRadius: "{border.radius.sm}" };
var f9 = { color: "{form.field.icon.color}" };
var a40 = { root: o83, dropdown: r81, overlay: d32, tree: l16, emptyMessage: e54, chip: i26, clearIcon: f9 };

// node_modules/@primeuix/themes/dist/aura/treetable/index.mjs
var o84 = { transitionDuration: "{transition.duration}" };
var r82 = { background: "{content.background}", borderColor: "{treetable.border.color}", color: "{content.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem" };
...
var k3 = { root: o84, header: r82, headerCell: e55, columnTitle: t39, row: c26, bodyCell: n38, footerCell: d33, columnFooter: l17, footer: i27, columnResizer: a41, resizeIndicator: g5, sortIcon: s10, loadingIcon: u6, nodeToggleButton: h4, paginatorTop: b4, paginatorBottom: f10, colorScheme: m3 };
...
var r83 = Object.defineProperty;
var e57 = Object.defineProperties;
...
var o86 = (e58, m5, i29) => m5 in e58 ? r83(e58, m5, { enumerable: true, configurable: true, writable: true, value: i29 }) : e58[m5] = i29;
var Nr;
var Qr = (Nr = ((r84, e58) => {
  for (var m5 in e58 || (e58 = {}))
    t40.call(e58, m5) && o86(r84, m5, e58[m5]);
  if (i28)
    for (var m5 of i28(e58))
      a42.call(e58, m5) && o86(r84, m5, e58[m5]);
  return r84;
})({}, e4), e57(Nr, m4({ components: { accordion: c, autocomplete: a, avatar: n, badge: d2, blockui: o5, breadcrumb: t2, button: e5, card: d3, carousel: t4, cascadeselect: f2, checkbox: e8, chip: s2, colorpicker: s3, confirmdialog: r14, confirmpopup: a6, contextmenu: c6, datatable: k, dataview: c8, datepicker: k2, dialog: e16, divider: t9, dock: d9, drawer: e18, editor: l7, fieldset: e20, fileupload: i10, floatlabel: d13, galleria: l8, iconfield: r29, iftalabel: i13, image: e23, imagecompare: r31, inlinemessage: a16, inplace: n12, inputchips: f6, inputgroup: o36, inputnumber: a17, inputotp: e26, inputtext: d16, knob: c11, listbox: n14, megamenu: g4, menu: r41, menubar: e29, message: u4, metergroup: b3, multiselect: n19, orderlist: o47, organizationchart: n20, overlaybadge: t22, paginator: n21, panel: a25, panelmenu: a26, password: n24, picklist: o54, popover: e37, progressbar: t26, progressspinner: r55, radiobutton: e39, rating: i21, ripple: o60, scrollpanel: a29, select: n25, selectbutton: d24, skeleton: o64, slider: a32, speeddial: a33, splitbutton: d25, splitter: t29, stepper: i23, steps: c17, tabmenu: n30, tabs: i24, tabview: e46, tag: n33, terminal: e47, textarea: d28, tieredmenu: c21, timeline: d29, toast: u5, togglebutton: c23, toggleswitch: c24, toolbar: r78, tooltip: e52, tree: d31, treeselect: a40, treetable: k3, virtualscroller: e56 } })));
export {
  Qr as default
};
