  ...
  function i(r2, n2, o2, i2) {
    ...
    return _regeneratorDefine2(u2, "_invoke", function(r3, n3, o3) {
      var i3, c3, u3, f2 = 0, p = o3 || [], y = false, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d2(t2, r4) {
        return i3 = t2, c3 = 0, u3 = e, G.n = r4, a2;
      } };
      function d(r4, n4) {
        ...
        for (y && 1 === p2 && d(p2, l), c3 = p2, u3 = l; (t = c3 < 2 ? e : u3) || !y; ) {
          ...
          try {
            if (f2 = 2, i3) {
              ...
              i3 = e;
            } else if ((t = (y = G.n < 0) ? u3 : r3.call(n3, G)) !== a2)
              break;
          } catch (t2) {
            i3 = e, c3 = 1, u3 = t2;
          } finally {
...
var useForm = function useForm2() {
  ...
  var isFieldValidate = function isFieldValidate2(field, validateOn2) {
    ...
    return value === true || b(value) && value.includes(field);
  };
        ...
        while (1)
          switch (_context4.n) {
            ...
            case 5:
              ...
              if (!(flattenFields.includes(fieldName) || !field || a(result.errors))) {
                _context4.n = 11;
                break;
              }
            ...
            case 9:
              fieldResult = _t8;
              b(fieldResult.errors) && (fieldResult.errors = _defineProperty({}, fieldName, fieldResult.errors));
              result = U(result, fieldResult);
            case 10:
...
function _unsupportedIterableToArray2(r, a2) {
  if (r) {
    if ("string" == typeof r)
      return _arrayLikeToArray2(r, a2);
    var t = {}.toString.call(r).slice(8, -1);
...
var script2 = {
  ...
  setup: function setup(props, _ref) {
    ...
    return _objectSpread2({
      ...
      onSubmit,
      onReset
    }, H($form, ["handleSubmit", "handleReset"]));
  }
};
