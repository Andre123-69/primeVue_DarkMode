...
var d = (e, t2) => {
  for (var n in t2 || (t2 = {}))
    ue.call(t2, n) && N(e, n, t2[n]);
  if (K)
    for (var n of K(t2))
      fe.call(t2, n) && N(e, n, t2[n]);
  return e;
};
function a(e) {
...
function R(e, t2, n = /* @__PURE__ */ new WeakSet()) {
  if (e === t2)
    return true;
  if (!e || !t2 || typeof e != "object" || typeof t2 != "object" || n.has(e) || n.has(t2))
    return false;
  n.add(e).add(t2);
  let r = Array.isArray(e), o = Array.isArray(t2), u, f2, h2;
  if (r && o) {
    if (f2 = e.length, f2 != t2.length)
      return false;
    for (u = f2; u-- !== 0; )
      if (!R(e[u], t2[u], n))
        return false;
  ...
  if (f2 = O2.length, f2 !== Object.keys(t2).length)
    return false;
  for (u = f2; u-- !== 0; )
    if (!Object.prototype.hasOwnProperty.call(t2, O2[u]))
      return false;
  for (u = f2; u-- !== 0; )
    if (h2 = O2[u], !R(e[h2], t2[h2], n))
      return false;
  return true;
}
function y(e, t2) {
...
function H(e, ...t2) {
  if (!i(e))
    return e;
  let n = d({}, e);
  return t2 == null || t2.flat().forEach((r) => delete n[r]), n;
}
function Y(e) {
...
function x2(t2) {
  for (let e of document == null ? void 0 : document.styleSheets)
    try {
      for (let o of e == null ? void 0 : e.cssRules)
        for (let n of o == null ? void 0 : o.style)
          if (t2.test(n))
...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s3 = d2.height, a2 = d2.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $2(), it = k2(), lt = h(), L, N2, ot = "top";
    f2.top + u + s3 > lt.height ? (L = f2.top + g3 - s3, ot = "bottom", L < 0 && (L = g3)) : L = u + f2.top + g3, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c2 - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x2(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l2 = e.offsetHeight, d2 = e.getBoundingClientRect(), s3 = h(), a2, u, c2 = n != null ? n : "top";
    if (!n && d2.top + l2 + i2.height > s3.height ? (a2 = -1 * i2.height, c2 = "bottom", d2.top + a2 < 0 && (a2 = -1 * d2.top)) : a2 = l2, i2.width > s3.width ? u = d2.left * -1 : d2.left + i2.width > s3.width ? u = (d2.left + i2.width - s3.width) * -1 : u = 0, t2.style.top = a2 + "px", t2.style.insetInlineStart = u + "px", t2.style.transformOrigin = c2, o) {
      ...
      return [r].flat().reduce((s3, a2) => {
        if (a2 != null) {
          ...
          if (u === "string" || u === "number")
            ...
            s3 = c2.length ? s3.concat(c2.filter((f2) => !!f2)) : s3;
          }
        }
        return s3;
      }, i2);
...
function b2(t2, e = "") {
  ...
  for (let r of o)
    getComputedStyle(r).display != "none" && getComputedStyle(r).visibility != "hidden" && n.push(r);
  return n;
}
function vt(t2, e) {
  let o = b2(t2, e);
...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K2(r), l2 = h(), d2 = t2.offsetParent ? t2.offsetWidth : J(t2), s3 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v2((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C2((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), c2 = "", f2 = "";
    i2.left + a2 + d2 > l2.width - P() ? i2.left < d2 ? e % 2 === 1 ? c2 = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (c2 = l2.width - d2 - P() + "px") : c2 = "-100%" : c2 = "100%", t2.getBoundingClientRect().top + u + s3 > l2.height ? f2 = `-${s3 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = c2;
  }
}
function Jt(t2, e) {
  let o = getComputedStyle(t2).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t2).getPropertyValue("paddingTop"), i2 = r ? parseFloat(r) : 0, l2 = t2.getBoundingClientRect(), s3 = e.getBoundingClientRect().top + document.body.scrollTop - (l2.top + document.body.scrollTop) - n - i2, a2 = t2.scrollTop, u = t2.clientHeight, c2 = C2(e);
  s3 < 0 ? t2.scrollTop = a2 + s3 : s3 + c2 > u && (t2.scrollTop = a2 + s3 - u + c2);
}
function Kt(t2, e = "", o) {
...
function g2() {
  let r = [], i2 = (e, n, t2 = 999) => {
    let s3 = u(e, n, t2), o = s3.value + (s3.key === e ? 0 : t2) + 1;
    return r.push({ key: e, value: o }), o;
  }, d2 = (e) => {
    r = r.filter((n) => n.value !== e);
  }, a2 = (e, n) => u(e, n).value, u = (e, n, t2 = 0) => [...r].reverse().find((s3) => n ? true : s3.key === e) || { key: e, value: t2 }, l2 = (e) => e && parseInt(e.style.zIndex, 10) || 0;
...
//# sourceMappingURL=chunk-FD5JR3Z2.js.map
