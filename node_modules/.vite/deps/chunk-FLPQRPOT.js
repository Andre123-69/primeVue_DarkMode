    ...
    bind: function bind(el, binding) {
      ...
      el.$_pstyleclass_clicklistener = function() {
        if (binding.value.toggleClass) {
          if (R(target, binding.value.toggleClass))
            O(target, binding.value.toggleClass);
          else
            W(target, binding.value.toggleClass);
        } else {
...
//# sourceMappingURL=chunk-FLPQRPOT.js.map
