<template>
    <div class="flex justify-end">
        <ul class="flex list-none m-0 p-0 gap-1 items-center">
            <li>
                <button type="button"
                    class="inline-flex w-8 h-8 p-0 items-center justify-center surface-0 dark:surface-800 border border-surface-200 dark:border-surface-600 rounded darktheme-toggler"
